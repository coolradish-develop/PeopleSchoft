...
{fld('Host (as seen from the agent):', cfg.get('hrDbHost') or 'hr-db when the agent runs in compose; otherwise set PS_HR_DB_HOST to the machine running hr-db (not localhost)')}{fld('Port:', {'postgres': '5432', 'mysql': '3306', 'mssql': '1433', 'oracle': '1521', 'db2': '50000'}.get(cfg['sqlExportDialect'] or 'postgres', ''))}
